...
namespace NgNet.Text
{
    ...
    public class Pinyin
    {
        ...
        #region 二级汉字及拼音首字母数组
        private const string ls_second_eng = "" +
        ...
        public static string GetFirstLetter(string hz)
        {
            ...
            for (int i = 0; i < hz.Length; i++)
            {
                ...
                {
                    sb.Append(ls_second_eng.Substring(ls_second_ch.IndexOf(hz[i].ToString(), 0), 1));
                }
            }
            return sb.ToString();
        }
        ...
        /// <returns>首字母</returns>
        public static string GetCodstring(string hz)
        {
            int i = 0;
            ushort key = 0;
            StringBuilder sb = new StringBuilder();
            ...
            byte[] unicodeBytes = unicode.GetBytes(hz);
